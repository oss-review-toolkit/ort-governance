...
- Martin explained that if the community votes for a new committer, the TFC must agree.

## Decisions

- The TSC held a vote on whether to proceed with the move to EF. The result was a 3-2 majority in favor, but this does not meet the 2/3 majority required to change the charter.
